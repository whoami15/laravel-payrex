...
[![GitHub Tests Action Status](https://img.shields.io/github/actions/workflow/status/whoami15/laravel-payrex/run-tests.yml?branch=main&label=tests&style=flat-square)](https://github.com/whoami15/laravel-payrex/actions?query=workflow%3Arun-tests+branch%3Amain)
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/whoami15/laravel-payrex/fix-php-code-style-issues.yml?branch=main&label=code%20style&style=flat-square)](https://github.com/whoami15/laravel-payrex/actions?query=workflow%3A"Fix+PHP+code+style+issues"+branch%3Amain)
...
You'll find full documentation on the [docs site](https://laravel-payrex.netlify.app).
