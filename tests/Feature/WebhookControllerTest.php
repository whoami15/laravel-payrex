...
function sendSignedWebhook(\LegionHQ\LaravelPayrex\Tests\TestCase $test, array $payload): \Illuminate\Testing\TestResponse
{
...
it('dispatches event with correct payload data', function () {
    ...
    $payload = [
        ...
        'type' => 'payment_intent.succeeded',
        'livemode' => false,
        'data' => ['resource' => ['id' => 'pi_payload_123', 'amount' => 50000]],
    ];
